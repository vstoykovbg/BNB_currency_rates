...
При изчисляване на капиталовата печалба се [взимат предвид данъчните лотове, както е по моето тълкуване на ЗДДФЛ](https://redtapepayments.blogspot.com/2025/03/31.html). Обаче ще трябва някои редове от таблицата с капиталовите пречалби ръчно да се коригират (да се махнат печалбите/загубите, реализирани на регулиран пазар) и да се махнат някои редове от таблицата с отворените позиции (тези на борсово търгувани инструменти, които не са акции/дялове).
