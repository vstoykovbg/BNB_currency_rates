...
> [!WARNING]  
> Прочетете внимателно по-надолу какво трябва да редактирате ръчно за да се спази ЗДДФЛ (основно проблемът е с установяването на това за кои продажби важи данъчно изключение).
