...
Какво става ако се омешат `.xml` файлове с данни за няколко акаунта не съм тествал какво става. Предполагам, че в такъв случай само няма да работи коректно изчисляването на удържаните данъци върху лихвите. Би трябвало да работи намирането на удържаните данъци за съответните дивиденти.
...
Справките FlexQuery трябва да ги генерирате в `.xml` формат. Трябва да са избрани следните секции:

* **Financial Instrument Information** - тук са данните за наименованията (за да излизат в справките наименования вместо тикери)
* **Trades** - тук са покупките и продажбите
* **Cash Transactions** - тук са дивидентите, лихвите и удържаните данъци върху дивиденти и лихви
* **Open Positions** - тук са отворените позиции
...
Възможно е да запишете данните в няколко файла, но не трябва да допускате дублиращи се данни. Например един файл само с **Open Positions** и отделен файл с всички останали секции.
