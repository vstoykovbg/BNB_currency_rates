...
VALID_ACTION = "Spending cashback"
        ...
        with open(input_filename, newline='', encoding='utf-8') as file:
            ...
            for row in reader:
                if row["Action"] != VALID_ACTION:
                    if row["Action"] not in ["Card debit", "Currency conversion", "Deposit", "New card cost", "Withdrawal"]:
            ...
            if mode == "sheet":
                ...
                with open(output_filename, "w", newline='', encoding='utf-8') as out_file:
                    ...
                    for r in processed_rows:
                        writer.writerow([r["date"], r["amount"], r["currency"], r["rate"], r["bgn_less"], r["bgn_more"]])
