...
**Първоначално тук качих само питонски скриптове, но по-късно направих готови електронни таблици, които автоматично избират правилния валутен курс според въведената дата (по-надолу ги разглеждам). Тези електронни таблици генерират CSV файлове, с които се захранва nap-autopilot.**
...
(За доходи от дивиденти направих отделна таблица, която да генерира директно csv за nap-autopilot. За доходи с код 508 не се сещам как може да се направи универсална таблица, само ако се продава един данъчен лот може да се ползва универсална таблица. Защото определянето на цена на придобиване е сложно когато се продава от повече от един данъчен лот и няма как изчисленията да станат на един ред за една продажба.)
