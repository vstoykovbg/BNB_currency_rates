...
За ползването на електронните таблици не е нужно инсталиране на Python, трябва ви само LibreOffice (актуална версия).
