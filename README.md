...
Внимание! Запознайте се с логиката на изчисления в този калкулатор за да разберете какви са му
ограниченията. Няма да изведе коректен резултат ако въведете покупки на активи, които не са продадени изцяло през данъчната година, която е обект на изчисления. Ако има продажби през други данъчни години резултатът от изчисленията няма да е правилен.
