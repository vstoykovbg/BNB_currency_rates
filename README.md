...
(Само за колони D и E трябва с плъзгане да приложите формулата за редовете след около стотния, защото няма макрос, който да го прави. Ако изобщо ви се налага да въвеждате 100 реда. Ако въвеждате 100 реда - помислете дали да не автоматизирате нещата по друг начин, 100 реда ръчно да преписвате е непрактично.)
