...
## Доходи с код 508 и 5082 формирани със "сложни" сделки (с които горния калкулатор не може да се справи)
...
и продавате 50% от тези акции, намалете цените на придобиване на всеки ред с 50% ето така:
