...
След като направих електронните таблици по-простите питонски скриптове е малко вероятно да ви потрябват освен скрипта за теглене на валутните курсове от сайта на БНБ и специализираните скриптове за [Interactive Brokers](README-IBKR.md) и [Trading212](README-T212.md).
