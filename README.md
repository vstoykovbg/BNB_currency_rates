...
В декларацията за 2024 година доходите от криптовалути са с отделен код (5082), поради което не трябва да ги слагате в една таблица с доходите с код 508. Изчисляват се по същия начин.
